				...
				<div className="flex flex-col md:flex-row justify-between items-center">
					<div className="flex space-x-4 justify-center items-center">
						<a href="https://www.instagram.com/ceciundurraga/" target="_blank">
							<FaInstagram className="text-2xl text-gray-600 hover:text-blue-600 transition-all duration-300 ease-in-out" />
						</a>
						<a href="https://wa.me/56982690613" target="_blank">
							<FaWhatsapp className="text-2xl text-gray-600 hover:text-blue-600 transition-all duration-300 ease-in-out" />
						</a>
						<a href="mailto:ceciundurraga@gmail.com" target="_blank">
							<IoMailOpenOutline className="text-2xl text-gray-600 hover:text-blue-600 transition-all duration-300 ease-in-out" />
						</a>
